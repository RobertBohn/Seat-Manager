...
//                   $('#header h1').html((e.pageX-12) + '-' + (e.pageY+0)    );
// 248 - 1096
 
                $.getJSON('gates/addseat.php?s=' + SM.next_seat_id + '&x=' + (e.pageX-12) + '&y=' + (e.pageY-154), function(data) {
             // RIGHT $.getJSON('gates/addseat.php?s=' + SM.next_seat_id + '&x=' + (e.pageX+364) + '&y=' + (e.pageY+211), function(data) {
             // LEFT    $.getJSON('gates/addseat.php?s=' + SM.next_seat_id + '&x=' + (e.pageX-12) + '&y=' + (e.pageY+206), function(data) {
                       SM.getShow();
                    });
                });
